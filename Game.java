...
public class Game extends Object {
    ...
    private void handleFigureLanded() {
        ...
        if (board.hasFullLines()) {
            ...
            if (level < 10 && board.getRemovedLines() >= (level * 3)) {
                level++; // 현재 레벨에서 10개의 라인을 제거할 때마다 레벨을 1 증가
                handleLevelModification();
            }
    ...
    private synchronized void handleKeyEvent(KeyEvent e) {
        ...
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_UP: //방향전환 키
                figure.rotateClockwise(); // 시계 방향으로 회전
                break;
